        ...
        hop_status.append(
            {
                ...
                "active_node": proxy_status_summary(active_proxy, active_key=active_key)
...
def build_endpoint_status_response(
    ...
    leases = chain_service.get_leases(
        pool_id=entry_pool_id or None, endpoint_id=endpoint_id or None
    )
