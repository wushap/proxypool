...
test.describe('Chain Routing (Round 8)', () => {
  ...
  test('chain flow visualization has node and arrow elements', async ({ page }) => {
    await navigateTo(page, '多跳代理池');
...
test.describe('Subscription Intelligence (Round 8)', () => {
  ...
  test('duplicate node analysis card shows status badge', async ({ page }) => {
    ...
    // Should have a warning or success badge
...
test.describe('System Diagnostics Health Score (Round 8)', () => {
